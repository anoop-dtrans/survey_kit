...
import 'package:survey_kit/src/views/duration_answer_view.dart';
...
class QuestionStep extends Step {
  ...
  Widget createView({required QuestionResult? questionResult}) {
    ...
    switch (answerFormat.runtimeType) {
      ...
      case DurationAnswerFormat:
        return DurationAnswerView(
          key: key,
          questionStep: this,
          result: questionResult as DurationQuestionResult?,
        );
      default:
